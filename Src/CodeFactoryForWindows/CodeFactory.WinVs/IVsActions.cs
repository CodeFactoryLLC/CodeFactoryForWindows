...
namespace CodeFactory.WinVs
{
    ...
    public interface IVsActions
    {
        ...
        /// <summary>
        /// Loads the <see cref="CsSource"/> from the target code file provided.
        /// </summary>
        /// <param name="filePath">Fully qualified path to the c# code file to load.</param>
        /// <returns>The C# source model or null if the model could not be loaded.</returns>
