...
namespace CodeFactory.WinVs.Factory
{
    ...
    public class CsClassResult : ISourceResult<CsClassResult>
    {
        /// <summary>
        ...
        /// <summary>
        /// The status of the class result, this indicates if the class was created, updated or skipped.
        /// </summary>
        public ResultStatusType Status { get; init; }

        /// <summary>
        /// The source that was used to create the class, this is typically the file that was processed.
        /// </summary>
        public required CsSource Source { get; init; }
