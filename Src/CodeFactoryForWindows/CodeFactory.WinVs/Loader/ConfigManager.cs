...
namespace CodeFactory.WinVs.Loader
{
    ...
    public static class ConfigManager
    {
        ...
        /// <param name="targetPackageName">The file name of the package that will be created. The package extension of cfa will be appended to the package name.</param>
        /// <returns></returns>
                                             ...
                                             string packageFilePath)
        {
            ...
            try
            {
                ...
                using (var codeFactoryPackage = Package.Open(packageFilePath, FileMode.Create))
                {
                    ...
                    //5-16-2023 SGiffin - Moving to Message back for storage in configuration.
                    byte[] seralizedConfig = MessagePackSerializer.Serialize<VsFactoryConfiguration>(config);
                    ...
                    var configStream = new MemoryStream(seralizedConfig);
                ...
                using (var codeFactoryPackage = Package.Open(packageFilePath, FileMode.Open))
                {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            //5-16-2023 Moving to Message back for configuration deserialization
                            resultData = MessagePackSerializer.Deserialize<VsFactoryConfiguration>(configStream);
                        }
                    }
