...
| CodeFactory Runtime | [CodeFactory for Windows](https://marketplace.visualstudio.com/items?itemName=CodeFactoryLLC.CodeFactoryForWindows) ≥ 2.26148.0.1 |
...
Or in your `.csproj`:
```xml
<PackageReference Include="CodeFactory.WinVs" Version="2.26148.0.1-PreRelease" />
```
...
### 2.26148.0.1-PreRelease
*Released: May 2026 — Branch: 2026-March*

#### 🆕 New

- **Visual Studio 2026 support** — This release targets the Visual Studio 2026 (v18.6) runtime. The CodeFactory runtime must be at version `2.26148.0.1` or higher to load automation built against this SDK.
...
- **Updated SDK version range** — The supported SDK version window has been updated:
  ...
  - Maximum supported SDK version: `2.26148.0.1`
...
>
> Ensure the CodeFactory runtime installed in Visual Studio is at least version `2.26148.0.1`.
