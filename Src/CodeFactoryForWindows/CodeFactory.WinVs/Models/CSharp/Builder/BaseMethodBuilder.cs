...
namespace CodeFactory.WinVs.Models.CSharp.Builder
{
    ...
    public abstract class BaseMethodBuilder:IMethodBuilder
    {
        ...
        public async Task<string> BuildMethodAsync(CsMethod sourceModel, ISourceManager manager, int indentLevel,
            string methodName = null, CsSecurity security = CsSecurity.Unknown, bool includeAttributes = false,
            ...
            MethodNameFormatting nameFormat = null)
        {
            ...
            return await GenerateBuildMethodAsync(sourceModel, manager, indentLevel, methodName,
                security,includeAttributes,ignoreAttributeTypes,includeKeywords,includeAbstractKeyword,abstractKeyword,
                sealedKeyword,staticKeyword,virtualKeyword,overrideKeyword,includeAsyncKeyword,defaultLogLevel,
                forceAsyncDefinition,syntax,multipleSyntax,nameFormat);
        }
        ...
        /// <param name="includeKeywords">Optional parameter that determines if the methods keywords will be included, default is false.</param>
        /// <param name="overrideKeyword">Optional, add the override keyword to the method definition, default is false.</param>
        public async Task InjectMethodAsync (CsMethod sourceModel, ISourceManager manager, 
            int indentLevel, InjectionLocation location = InjectionLocation.MethodAfter, 
            string methodName = null, CsSecurity security = CsSecurity.Unknown, bool includeAttributes = false,
            IEnumerable<string> ignoreAttributeTypes = null, bool includeKeywords = false,
            bool includeAbstractKeyword = false, bool abstractKeyword = false, bool sealedKeyword = false,
            bool staticKeyword = false, bool virtualKeyword = false, bool overrideKeyword = false,
            ...
            MethodNameFormatting nameFormat = null)
        {
            ...
            var methodSyntax = await GenerateBuildMethodAsync(sourceModel, manager, indentLevel, methodName,
                security,includeAttributes,ignoreAttributeTypes,includeKeywords,includeAbstractKeyword,abstractKeyword,
                sealedKeyword,staticKeyword,virtualKeyword,overrideKeyword,includeAsyncKeyword,defaultLogLevel,
                forceAsyncDefinition,syntax,multipleSyntax,nameFormat);
        ...
        /// <param name="overrideKeyword">Optional, add the override keyword to the method definition, default is false.</param>
        /// <returns>Formatted method definition.</returns>
        public abstract Task<string> GenerateBuildMethodAsync(CsMethod sourceModel, ISourceManager manager, int indentLevel,
            string methodName = null,CsSecurity security = CsSecurity.Unknown, bool includeAttributes = false,
            IEnumerable<string> ignoreAttributeTypes = null, bool includeKeywords = false,
            bool includeAbstractKeyword = false, bool abstractKeyword = false, bool sealedKeyword = false,
            bool staticKeyword = false, bool virtualKeyword = false, bool overrideKeyword = false,
