...
namespace CodeFactory.WinVs.Models.CSharp.Builder
{
    ...
    public abstract class BaseEventBuilder:IEventBuilder
    {
        ...
        public async Task<string> BuildEventAsync(CsEvent sourceModel, ISourceManager manager, int indentLevel, string eventName = null,
            ...
            bool staticKeyword = false, bool virtualKeyword = false, string syntax = null, IEnumerable<NamedSyntax> multipleSyntax = null,
            NameFormatting nameFormat = null)
        {
            if(sourceModel == null) throw new ArgumentNullException(nameof(sourceModel));
            if (manager == null) throw new ArgumentNullException(nameof(manager));

            return await GenerateBuildEventAsync(sourceModel,manager, indentLevel, eventName, type, security, includeAttributes,
                ignoreAttributeTypes, abstractKeyword, sealedKeyword, staticKeyword, virtualKeyword, syntax, multipleSyntax, nameFormat);
        }
        ...
        /// <param name="sealedKeyword">Optional, add the sealed keyword to the event definition, default is false.</param>
        /// <param name="staticKeyword">Optional, set the event to be static, default is false.</param>
        public async Task InjectEventAsync(CsEvent sourceModel, ISourceManager manager, int indentLevel,
            InjectionLocation location = InjectionLocation.EventAfter, string eventName = null, CsType type = null,
            ...
            string syntax = null, IEnumerable<NamedSyntax> multipleSyntax = null, NameFormatting nameFormat = null)
        {
            ...
            var eventSyntax = await GenerateBuildEventAsync(sourceModel,manager, indentLevel, eventName, type, security, includeAttributes,
                ignoreAttributeTypes, abstractKeyword, sealedKeyword, staticKeyword, virtualKeyword, syntax, multipleSyntax, nameFormat);
        ...
        /// <param name="staticKeyword">Optional, set the event to be static, default is false.</param>
        /// <returns>Formatted event definition.</returns>
        protected abstract Task<string> GenerateBuildEventAsync(CsEvent sourceModel, ISourceManager manager, int indentLevel,
            string eventName = null,
            CsType type = null, CsSecurity security = CsSecurity.Unknown, bool includeAttributes = false,
            IEnumerable<string> ignoreAttributeTypes = null, bool abstractKeyword = false, bool sealedKeyword = false,
            bool staticKeyword = false, bool virtualKeyword = false, string syntax = null,
