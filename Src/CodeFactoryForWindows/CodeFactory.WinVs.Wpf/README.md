...
Or in your `.csproj`:
```xml
<PackageReference Include="CodeFactory.WinVs.Wpf" Version="2.26148.0.1-PreRelease" />
```
...
- Aligned with `CodeFactory` and `CodeFactory.WinVs` package version `2.26148.0.1-PreRelease`.
