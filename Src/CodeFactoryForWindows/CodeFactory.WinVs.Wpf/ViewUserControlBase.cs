...
using CodeFactory.WinVs.UI;

namespace CodeFactory.WinVs.Wpf
{
    /// <summary>
    /// The base implementation of a WPF <see cref="ViewUserControl"/> that has been extended to provide direct access to visual studio for code factory integration.
    /// </summary>
    public  class ViewUserControl : UserControl,IView
    {
        ...
        public ViewUserControl(IVsActions actions, ILogger logger) : base()
        {
            _logger = logger;
        ...
        /// <summary>
        /// Backing store for the dependance property <see cref="Title"/> 
        /// </summary>
        // Using a DependencyProperty as the backing store for Title.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register("Title", typeof(string), typeof(ViewUserControl));
