...
using CodeFactory.WinVs.Loader;
    ...
    public static class Program
    {
        public static void Main(string[] args)
        {
            ...
            commandLine.OnExecute(() =>
            {
                ...
                var result = CodeFactory.WinVs.Loader.ConfigManager.CreateCodeFactoryPackage(factoryConfig, assemblyDirectory, assemblyName);
        ...
        private static int UpdateAssemblyInfo(string assemblyPath)
        {
            ...
            try
            {
                ...
                var usingStatement = "using CodeFactory.WinVs;";
        ...
        private static int WriteNewAssemblyInfo(string assemblyPath)
        {
            ...
            try
            {
                assemblyFileContents.Add("using CodeFactory.WinVs;");
